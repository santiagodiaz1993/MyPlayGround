...
class Loss:
    ...
    def calculate(self, output, y, *, include_regularization=False):
        ...
        print("This is X and y whil coming in into calculate")
        print(output.shape)
        print(y.shape)
...
class Model:
    ...
    def train(self, X, y, *, epochs=1, print_every=1, validation_data=None):
        ...
        for epoch in range(1, epochs + 1):
            ...
            print("This is x and y before getting passed into predictions")
            print(output.shape)

            # Get predictions and calculate an accuracy
            predictions = self.output_layer_activation.predictions(output)
            print("This is X and y before getting passed in into calulcate")
            print(predictions.shape)
            print(y.shape)
    ...
    def forward(self, X, training):
        ...
        # return its output
        print("This is after it gets passed through forward")
...
print("This is as soon as they are extracted")
print(X.shape)
print(y.shape)
